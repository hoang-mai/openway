...
export const labelColorConfig: Record<TimePickerColor, string> = {
  primary:
    "text-neutral-700 group-focus-within/timepicker:text-primary-600 group-data-[state=open]/timepicker:text-primary-600 group-data-[state=open]/field:text-primary-600 group-data-[state=open]:text-primary-600 group-aria-expanded/timepicker:text-primary-600",
  secondary:
    "text-neutral-700 group-focus-within/timepicker:text-secondary-600 group-data-[state=open]/timepicker:text-secondary-600 group-data-[state=open]/field:text-secondary-600 group-data-[state=open]:text-secondary-600 group-aria-expanded/timepicker:text-secondary-600",
  error:
    "text-error-600 group-focus-within/timepicker:text-error-600 group-data-[state=open]/timepicker:text-error-600 group-data-[state=open]/field:text-error-600 group-data-[state=open]:text-error-600 group-aria-expanded/timepicker:text-error-600",
  success:
    "text-neutral-700 group-focus-within/timepicker:text-success-600 group-data-[state=open]/timepicker:text-success-600 group-data-[state=open]/field:text-success-600 group-data-[state=open]:text-success-600 group-aria-expanded/timepicker:text-success-600",
  warning:
    "text-neutral-700 group-focus-within/timepicker:text-warning-600 group-data-[state=open]/timepicker:text-warning-600 group-data-[state=open]/field:text-warning-600 group-data-[state=open]:text-warning-600 group-aria-expanded/timepicker:text-warning-600",
  info:
    "text-neutral-700 group-focus-within/timepicker:text-info-600 group-data-[state=open]/timepicker:text-info-600 group-data-[state=open]/field:text-info-600 group-data-[state=open]:text-info-600 group-aria-expanded/timepicker:text-info-600",
  neutral:
    "text-neutral-700 group-focus-within/timepicker:text-neutral-900 group-data-[state=open]/timepicker:text-neutral-900 group-data-[state=open]/field:text-neutral-900 group-data-[state=open]:text-neutral-900 group-aria-expanded/timepicker:text-neutral-900",
};
