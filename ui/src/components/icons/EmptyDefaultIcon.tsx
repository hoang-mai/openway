...
export function EmptyDefaultIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 96 96" fill="none" xmlns="http://www.w3.org/2000/svg" className="size-full" {...props}>
      {/* Ground Shadow */}
      <ellipse cx="48" cy="80" rx="36" ry="8" className="fill-neutral-200/60" />
      <ellipse cx="48" cy="80" rx="22" ry="4.5" className="fill-neutral-300/50" />

      {/* Back Flaps (Opening outward at a lower, gentle angle) */}
      {/* Back Left Flap */}
      <path
        d="M24 38L16 32L40 22L48 28L24 38Z"
        className="fill-primary-100/80 stroke-primary-300"
        strokeWidth="1.5"
      ...
      <path
        ...
        className="fill-primary-300/80 stroke-primary-300/40"
        strokeWidth="1"
        strokeLinejoin="round"
      />
      ...
      <path
        ...
        className="fill-primary-300/60 stroke-primary-300/40"
        strokeWidth="1"
        strokeLinejoin="round"
      />
      {/* Inside Bottom Floor */}
      <path
        ...
        className="fill-primary-400/40 stroke-primary-400/30"
        strokeWidth="1"
        strokeLinejoin="round"
      />
      ...
      <path
        ...
        className="fill-primary-100 stroke-primary-400"
        strokeWidth="1.8"
        strokeLinejoin="round"
      />
      {/* Outer Right Wall */}
      <path
        ...
        className="fill-primary-200/90 stroke-primary-400"
        strokeWidth="1.8"
        strokeLinejoin="round"
      />
      ...
      <path
        ...
        className="fill-primary-100/90 stroke-primary-300"
        strokeWidth="1.5"
        strokeLinejoin="round"
      />
    </svg>
