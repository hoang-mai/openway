...
export function EmptyErrorIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg" className="size-full" {...props}>
      <ellipse cx="60" cy="100" rx="42" ry="10" className="fill-neutral-200/50 dark:fill-neutral-800/50" />
      ...
      <circle
        ...
        cy="52"
        r="32"
        className="fill-error-50 dark:fill-error-950/40 stroke-error-200 dark:stroke-error-800"
        strokeWidth="2"
      />
      ...
      <path
        ...
        className="fill-error-100 dark:fill-error-900/60 stroke-error-500"
        strokeWidth="2.5"
