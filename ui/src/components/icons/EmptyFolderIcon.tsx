...
export function EmptyFolderIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg" className="size-full" {...props}>
      <ellipse cx="60" cy="98" rx="42" ry="10" className="fill-neutral-200/50 dark:fill-neutral-800/50" />
      ...
      <path
        ...
        className="fill-primary-200/70 dark:fill-primary-900/60 stroke-primary-300 dark:stroke-primary-700"
        strokeWidth="2"
      />
      ...
      <path
        ...
        className="fill-primary-300/80 dark:fill-primary-800/70 stroke-primary-400 dark:stroke-primary-600"
        strokeWidth="2"
      />
    </svg>
  );
