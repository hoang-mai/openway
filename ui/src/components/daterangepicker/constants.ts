...
export const labelColorConfig: Record<DateRangePickerColor, string> = {
  primary:
    "text-neutral-700 group-focus-within/field:text-primary-600 group-data-[state=open]/field:text-primary-600 group-data-[state=open]/daterangepicker:text-primary-600 group-data-[state=open]:text-primary-600 group-aria-expanded/field:text-primary-600",
  secondary:
    "text-neutral-700 group-focus-within/field:text-secondary-600 group-data-[state=open]/field:text-secondary-600 group-data-[state=open]/daterangepicker:text-secondary-600 group-data-[state=open]:text-secondary-600 group-aria-expanded/field:text-secondary-600",
  error:
    "text-error-600 group-focus-within/field:text-error-600 group-data-[state=open]/field:text-error-600 group-data-[state=open]/daterangepicker:text-error-600 group-data-[state=open]:text-error-600 group-aria-expanded/field:text-error-600",
  success:
    "text-neutral-700 group-focus-within/field:text-success-600 group-data-[state=open]/field:text-success-600 group-data-[state=open]/daterangepicker:text-success-600 group-data-[state=open]:text-success-600 group-aria-expanded/field:text-success-600",
  warning:
    "text-neutral-700 group-focus-within/field:text-warning-600 group-data-[state=open]/field:text-warning-600 group-data-[state=open]/daterangepicker:text-warning-600 group-data-[state=open]:text-warning-600 group-aria-expanded/field:text-warning-600",
  info:
    "text-neutral-700 group-focus-within/field:text-info-600 group-data-[state=open]/field:text-info-600 group-data-[state=open]/daterangepicker:text-info-600 group-data-[state=open]:text-info-600 group-aria-expanded/field:text-info-600",
  neutral:
    "text-neutral-700 group-focus-within/field:text-neutral-900 group-data-[state=open]/field:text-neutral-900 group-data-[state=open]/daterangepicker:text-neutral-900 group-data-[state=open]:text-neutral-900 group-aria-expanded/field:text-neutral-900",
};
